...
function ninja_forms_add_menu(){
	...
	$subs = add_submenu_page( 'ninja-forms', __( 'Submissions', 'ninja-forms' ), __( 'Submissions', 'ninja-forms' ), $capabilities, 'edit.php?post_type=ninja_forms_sub', "ninja_forms_admin");
